...
- `projects/<PROJECT>/docs/plan.json` 始终是执行状态真相源，`docs/PLAN.md` 与 `docs/TODO.md` 仅为派生/补充文档。
...
3. 基于最新 `plan.json` 重建 `docs/TODO.md`（项目级备注/跟进视图）
...
5. 使用新 `plan.json` 重新生成 `docs/PLAN.md` 与 `docs/TODO.md`。
